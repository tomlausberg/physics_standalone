...
def taugb03a(
    tau_major: Field[(DTYPE_FLT, (ng03,))],
    laytrop: FIELD_BOOL,
    colamt: Field[type_maxgas],
    rfrate: Field[(DTYPE_FLT, (nrates, 2))],
    fac00: FIELD_FLT,
    ...
    with computation(PARALLEL), interval(1, None):
        if laytrop:
            ...
            for ig in range(ng03):
                ...
                taug[0, 0, 0][ns03 + ig] = (
                    tau_major[0,0,0][ig] + tauself + taufor + adjcoln2o * absn2o
                )
            ...
            for ig2 in range(ng03):
                ...
                taug[0, 0, 0][ns03 + ig2] = (
                    tau_major[0,0,0][ig2] + taufor + adjcoln2o * absn2o
                )
